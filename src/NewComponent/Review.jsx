...
export default function Review() {
  ...
  <p class="mb-6 pb-2 text-black"> elit. Fugit, error
  ...
  <div class="mb-12 md:mb-0">
    <div class="mb-6 flex justify-center">
      <img
        ...
        class="w-32 rounded-full shadow-lg dark:shadow-black/30"  alt='@'/>
    </div>
    <h5 class="mb-4 text-xl font-semibold">Maria Smantha</h5>
    <h6 class="mb-4 font-semibold text-primary text-primary-400">
      Web Developer
    </h6>
